...
use crate::{
    ...
    note_encryption::{EphemeralKeyBytes, OutgoingCipherKey, ENC_CIPHERTEXT_SIZE},
...
impl SpendUpdater<'_> {
    ...
    pub fn set_rseed(&mut self, rseed: crate::note::Rseed) {
    ...
    /// Sets the note commitment randomness for this spend.
    pub fn set_rcm(&mut self, rcm: [u8; 32]) {
        self.0.rcm = Some(rcm);
    }
}
